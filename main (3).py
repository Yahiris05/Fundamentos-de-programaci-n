#Examen Parcial de Aarón Beltre 24-1033

#Mandato: Realizar un programa que capture 4 notas de los estudiantes y que determine el
def capturar_notas():
      while True:
          ...
          otra_vez = input("¿Desea ingresar otro estudiante?: ").strip().lower()
          if otra_vez != 'si':
              break
